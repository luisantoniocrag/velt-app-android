...
object VeltSensorBioService {
    ...
    // DEMO HACK (temporal): el bioserver (openpalm.io) está caído (500/404), así que devolvemos un
    // personId fijo en vez de identificar la palma. Poner DEMO_OVERRIDE=false para volver a llamarlo.
