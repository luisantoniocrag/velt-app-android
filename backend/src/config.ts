 ...
 * Falla de forma ruidosa al arranque si falta algo (mejor que un crash a mitad de un pago).
 * Nunca se loguea el contenido de los secretos.
 */
...
const schema = baseSchema.superRefine((cfg, ctx) => {
  // Requisitos condicionales según el signer seleccionado.
